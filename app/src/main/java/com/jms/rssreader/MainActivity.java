...
public class MainActivity extends Activity implements RefreshableInterface {
	...
	private String urlString = "http://www.transport.se/Transportarbetaren/Rss-Sida/Transportarbetaren?paged="; //please set enablePagnation = true
	...
	private OnItemClickListener onItemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
			...
			postviewIntent.putExtra("link", guidList.get(arg2 - 1));
		...
		protected ArrayList<PostData> doInBackground(String... params) {
			...
			try {
				...
				SimpleDateFormat dateFormat = new SimpleDateFormat(
						"EEE, d/M yyyy HH:mm", Locale.ENGLISH);
